module ISO8583
  ...
  LLLXXFixedSizeSubfield.new.set_subfield(F62_numeric_id2subfield, F62_string_id2subfield, 10, 20, :merchant_verification_value, 'BM 62: Merchant Verification Value', false)
