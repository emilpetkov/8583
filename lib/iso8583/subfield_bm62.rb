module ISO8583
  ...
  F62_Codec = Codec.new
  F62_Codec.encoder = lambda { |params_hashtable, message| serialize_fixed_subfields(62, F62_string_id2subfield, params_hashtable, message) }
  F62_Codec.decoder = lambda { |raw, message| deserialize_fixed_subfields(62, F62_string_id2subfield, raw, message) }
end