...
class FieldTest < Test::Unit::TestCase
  ...
  def test_LLL_SUBFIELD_BMP_60
    ...
    assert_equal encoded_value, "\xF0\xF3\xF2\xF0\xF1\xF3\xF8\xF1\xF0\xF0\xF0\xF0\xF1\xF1\xF1\xF1\xF2\xF2\xF2\xF0\xF1\xF3\xF8\xF2\xF0\xF0\xF0\xF0\xF3\xF4\xF5\xF6\xF7\xF8\xF9".force_encoding('ASCII-8BIT')

    encoded_value = LLL_SUBFIELD_BMP_60.encode({ iso_id: '00003456789' }, nil)
    assert_equal encoded_value, "\xF0\xF1\xF6\xF0\xF1\xF3\xF8\xF2\xF0\xF0\xF0\xF0\xF3\xF4\xF5\xF6\xF7\xF8\xF9".force_encoding('ASCII-8BIT')
    ...
    value, _rest = LLL_SUBFIELD_BMP_60.parse("\xF0\xF1\xF6\xF0\xF1\xF3\xF8\xF2\xF0\xF0\xF0\xF0\xF3\xF4\xF5\xF6\xF7\xF8\xF9".force_encoding('ASCII-8BIT'), nil)
    assert_equal value, { 'Independent Sales Organization' => '00003456789' }
  end
